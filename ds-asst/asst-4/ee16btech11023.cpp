...
// struct which holds the details of a node in the linked list
struct node{
  int val;
  node *next;
  node *prev;
...
void BST :: pre_order_to_tree(list a){
  node *tmp=a.head;
  node_bst *temp;
  root=new node_bst;
  root->val=a.head->val;
...
int main(){
  ...
  int flag5=0,flag6=0,flag7=0,flag8=0,flag9=0;
  long long int a=0;
  node_bst *tmp;
  BST bst;
  list lst;
  // flag9 converts pre order to tree
