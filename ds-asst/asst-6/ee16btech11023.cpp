...
// until the heap is empty. Initialises all the distances to INF and updates them as per the traversal. the condition d(v) > d(u)+weight(u,v) is used for this purpose.
